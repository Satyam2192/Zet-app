...
const Footer = () => {
  return (
    <footer className="footer ">
      <div
        className="container mx-auto pb-16 pt-1 px-4 md:px-6 lg:px-8 xl:px-10 text-white"
        style={{
          backgroundImage:
        ...
        <div className="max-w-6xl mx-auto mb-[152px] mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
            <div>
              ...
              <ul className="mb-4 ">
                <li className="mb-2">
                  <a className="font-sans font-light" href="/about">About Us</a>
                </li>
                <li className="mb-2">
                  <a className="font-sans font-light" href="/partner">Partner with us</a>
                </li>
                <li className="mb-2">
                  <a className="font-sans font-light" href="/blog">Blog</a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="mb-4 ">
                <li className="mb-2">
                  <a className="font-sans font-light" href="/privacy">Privacy Policy</a>
                </li>
                <li className="mb-2">
                  <a className="font-sans font-light" href="/terms">Terms of Use</a>
                </li>
              </ul>
            </div>
            <div>
